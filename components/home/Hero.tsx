...
function Hero() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center md:items-start px-4 md:px-20 pt-40 md:pt-72">
        ...
        <h2 className="text-lg text-gray-400 max-w-2xl text-center md:text-start font-semibold mt-4">
          Alchemyst AI empowers your team with an AI-powered sales platform that
          automates lead generation, outreach, and personalization - boosting
...
// LAST SHIPped CODE WHICH I LIKED:
// "use client";
// import React from "react";
// import Link from "next/link";
// import Button from "./Button";
...
//         {/* The description Section */}
//         <div className="mt-4">
//           <h2 className="text-lg text-gray-400 pl-10 pr-10 md:pl-20 md:pr-0 max-w-2xl text-center md:text-start font-semibold">
...
//   return (
//     <div className="relative md:w-full md:h-screen overflow-hidden">
//       <video
//         autoPlay
//         loop
//         muted
...
//                     width={50}
//                     height={10}
//                     className="h-12 w-36 md:h-12 md:w-52"
//                     loading="eager"
//                     quality={100}
//                   />
//                 </div>
