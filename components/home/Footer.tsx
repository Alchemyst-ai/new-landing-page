        ...
        <div className="w-full md:w-1/6 mb-8 md:mb-0 flex items-center justify-center md:justify-start">
          ...
          >
            ...
            <p className="text-sm text-gray-400 mt-4 text-center md:text-left">
              © {currentYear} Ionida Limited trading as AlchemystAI UK, West Midlands, UK. All rights
              reserved.
            </p>
        ...
        <div className="hidden md:flex w-5/6 justify-between gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-400">sales@alchemystai.co.uk</span>
            </div>
            <div className="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="text-gray-400">AlchemystAI UK, West Midlands, UK</span>
            </div>
            <motion.div
