...
const Benefits: React.FC = () => {
  return (
    <div className=" flex flex-col justify-center items-center">
      ...
      <motion.div
        className="border p-2 w-[80vw] md:w-[20vw] md:h-[12vh] rounded-3xl"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        viewport={{ once: false }}
      >
        <div className="border border-dashed rounded-3xl p-4 md:h-[12vh] w-[20vw] bg-[#1F1F1C] flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
        <motion.div
          className="p-2 w-[80vw] md:w-[12vw] h-[15vh] md:h-[8vh] flex justify-center items-center"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          viewport={{ once: false }}
        ...
        <motion.div
          className="border p-2 w-[80vw] md:w-[12vw] h-[15vh] md:h-[8vh] rounded-tl-3xl"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          viewport={{ once: false }}
        >
          <div className="border border-dashed rounded-tl-3xl p-4 md:p-8 w-[80vw] md:w-[12vw] h-[15vh] md:h-[8vh] bg-[#1F1F1C] flex flex-col justify-center items-center">
        ...
        <motion.div
          className="border p-2 w-[80vw] md:w-[12vw] h-[15vh] md:h-[8vh] rounded-tr-3xl"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          viewport={{ once: false }}
        >
          <div className="border border-dashed rounded-tr-3xl p-4 md:p-8 w-[80vw] md:w-[12vw] h-[15vh] md:h-[8vh] bg-[#1F1F1C] flex flex-col justify-center items-center">
            <h1 className="text-2xl font-semibold text-[#21dbd8]">Analytics</h1>
          </div>
        </motion.div>
        <motion.div
          className="p-2 w-[80vw] md:w-[12vw] h-[15vh] md:h-[8vh] flex justify-center items-center -ml-10"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          viewport={{ once: false }}
      ...
      <motion.div
        className="border p-2 w-[80vw] md:w-[25vw] md:h-[16vh] rounded-3xl"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        viewport={{ once: false }}
      >
        <div className="border border-dashed rounded-3xl p-4 md:h-[16vh] w-[25vw] bg-[#1F1F1C] flex flex-col justify-center items-center">
      ...
      <motion.div
        className="border p-2 w-[80vw] md:w-[18vw] md:h-[10vh] rounded-3xl "
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        viewport={{ once: false }}
      >
        <div className="border border-dashed rounded-3xl p-4 md:h-[10vh] w-[18vw] bg-[#1F1F1C] flex flex-col justify-center items-center">
