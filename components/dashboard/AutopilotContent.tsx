        ...
        >
          <div className="flex flex-col md:flex-row items-center md:p-10">
            <div className="md:w-1/2 md:pr-8 mb-8 md:mb-0">
              ...
              <ul className="list-disc list-inside text-lg text-gray-400 text-center md:text-left mt-5">
                <li className="mb-8">
                ...
                <li className="mb-2">
                  ...
                  and delivers results you can count on. Maya is here to
                  transform the way you work, one task at a time.
                </li>
              </ul>
