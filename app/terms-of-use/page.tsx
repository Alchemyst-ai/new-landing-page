...
that by accessing the website, you have read, understood, and agreed to be bound by all of these
...
The Website is owned and operated by Xalchemyst Technologies Private Limited. We have
been incorporated under the Companies Act, 2013 under CIN U62011WB2024PTC270934
having its registered office at 3rd Floor, Flat 3/A, 20 P C Ghosh Road, Patipukur, North
24Parganas, Patipukur, West Bengal, India, 700048.
Our artificial intelligence platform enables the business by providing products/services which
helps them in automating various business processes like sales automation, marketing
automation, communication, software development, technology platforms, cloud-based
platforms, data storage, web designing, Information Technology, database, IT tools and
information products, web and mobile application development, lead generation, user interface
solutions.
2. INTELLECTUAL PROPERTY RIGHTS
...
competition laws of the India, international copyright laws, and international conventions. The
Content and the Marks are provided on the Site “Alchemyst AI” for your information and
...
human means, whether through a bot, script, or otherwise; (6) you will not use the Site for any
illegal or unauthorized purpose; and (7) your use of the Site will not violate any applicable law
or regulation.
...
4. USER REGISTRATION
Our platform does not require any User Registration. For the purpose of submitting of
information, any user can submit the information through Alchemyst Website. By agreeing to
the Terms, you agree to receive promotional, transactional or other communications, and
newsletters from the Company. You can opt out from such communications and/or newsletters
by using or clicking the link for the opt out options as available in such communications.
As part of the process for usage and access of the Alchemyst Website, the Company may collect
your personally identifiable information/ preferences, including but not limited to name, email
address, age, address, mobile phone number, and other contact details, demographic profile
(like your age, gender, occupation, education, address etc). Information so collected is subject
...
available. The Site may not be used in connection with any commercial endeavours except
...
6. LICENSE AND ACCESS
Subject to the provisions set out in these Terms, the Company grants you a personal, limited,
non-exclusive, non-transferable and revocable license to access (for personal use only) the
Alchemyst Website and avail the Services, only as expressly permitted in these Terms.
Such limited license does not include/permit any resale or commercial use of the Alchemyst
Website or its contents; any collection, use or derivative use of the Website, its contents, any
product listings, descriptions, or prices; any downloading or copying of information for the
benefit of another third party; or any use of data mining, robots, or similar data gathering and
extraction tools.
You hereby agree and undertake not to use, host, display, upload, modify, publish, transmit,
update or share any information/ content/ message/ language/ document (including pursuant to
gifting services/ printing services/ orders to be delivered to someone else-3rd party recipients/
messages to be delivered along with the order) (whether in writing or otherwise while
communicating on the Alchemyst AI Platform including but not limited to communicating with
our support agents or delivery partners, through any medium) which (“Prohibited Conduct”):
• Belongs to another person and to which you do not have any right or full rights;
• Is harmful, threatening, abusive, indecent, discriminatory, tortious, vulgar, profane,
harassing, blasphemous, defamatory, problematic, obscene, pornographic, paedophilic,
...
offensive, objectionable, menacing, inappropriate or unlawful in any manner whatever;
...
• Disguises or attempts to disguise the origin of your messages, content, including but
not limited to by: (a) submitting your content under a false name or false pretences; or
(b) disguising or attempting to disguise the IP address from which your content is
submitted;
• Harms minors in any way;
• Infringes any patent, trademark, copyright or another proprietary/intellectual property
right;
• https://chatgpt.com/c/67383c4c-9f34-8007-857b-2ed90fbfb16dViolates any applicable law and/ or may result in a civil/ criminal liability;
...
support purposes), to ensure your compliance with the terms and to comply with applicable
law or the order or requirement of legal process, a court, consent decree, administrative agency
or other governmental body.
Any and all liability arising out of or relating to violation of these Terms including in relation
to the aforesaid information/ content/ message is your sole and absolute responsibility, and not
of the company.
Alchemyst Website or any portion of the Website may not be reproduced, duplicated, copied,
sold, resold, visited, or otherwise exploited for any commercial purpose without express prior
written consent of the company.
You may not frame or utilize framing techniques to enclose any trademark, logo, or other
proprietary information (including images, text, page layout, or form) of the Website or of the
company and/or its group companies/ affiliates without the express prior written consent of the
company.
You may not use any meta tags or any other “hidden text” utilizing the company’s name or
trademarks without the express prior written consent of the company.
You shall not attempt to gain unauthorized access to any portion or feature of the Website, or
any other systems or networks connected to the Website or to any server, computer, network,
...
and/or grant us access to your Third-Party Account, without breach by you of any of the terms
...
third-party service provider of the Third-Party Account. By granting us access to any Third-
...
Site. You will have the ability to disable the connection between your account on the Site and
...
infringement, and we are not responsible for any Social Network Content. You acknowledge
and agree that we may access your email address book associated with a Third-Party Account
and your contacts list stored on your mobile device or tablet computer solely for purposes of
identifying and informing you of those contacts who have also registered to use the Site. You
can deactivate the connection between the Site and your Third-Party Account by contacting us
...
Party Account, except the username and profile picture that become associated with your
account.
8. SUBMISSIONS
...
linking to, or permitting the use or installation of any Third-Party Websites or any Third-Party
Content does not imply approval or endorsement thereof by us. If you decide to leave the Site
...
website to which you navigate from the Alchemyst AI or relating to any applications you use
or install from the Alchemyst AI. Any purchases you make through Third-Party Websites will
...
or liability, to remove from the Site or otherwise disable all files and content that are excessive
...
differ from applicable laws in India, then through your continued use of the Site, you are
transferring your data to India, and you agree to have your data transferred to and processed
in India.
12. COPYRIGHT INFRINGEMENTS
...
that material located on or linked to by the Alchemyst AI infringes your copyright, you should
...
LIABILITY, DENY ACCESS TO AND USE OF THE ALCHEMYST AI (INCLUDING
...
YOUR USE OR PARTICIPATION IN THE ALCHEMYST AI OR DELETE YOUR
...
suspend, discontinue, or otherwise modify the Alchemyst AI at any time or for any reason
without notice to you. You agree that we have no liability whatsoever for any loss, damage, or
inconvenience caused by your inability to access or use the Alchemyst AI during any downtime
or discontinuance of the Alchemyst AI. Nothing in these Terms of Use will be construed to
obligate us to maintain and support the Alchemyst AI or to supply any corrections, updates, or
...
be held at West Bengal and all proceedings in any such arbitration shall be conducted in
English. There shall be 3 (three) arbitrators (“Arbitrators”), all of whom shall be fluent in
English. Within thirty 30 (thirty) Days of the reference of the dispute to arbitration, the Party
raising the dispute and making the reference to arbitration shall appoint one Arbitrator and the
other Party shall appoint the other Arbitrator. The third Arbitrator shall be appointed by the 2
(two) appointed Arbitrators. The arbitral award shall be final and binding upon the parties. The
Parties shall equally bear the costs and expenses for the conduct of the arbitration proceedings,
however; each Party shall bear their own legal expenses.
Restrictions
...
information on the Alchemyst AI at any time, without prior notice.
18. DISCLAIMER
...
IMPLIED, IN CONNECTION WITH THE ALCHEMYST AI AND YOUR USE THEREOF,
...
OF ANY WEBSITES LINKED TO THE ALCHEMYST AI AND WE WILL ASSUME NO
LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR
INACCURACIES OF CONTENT AND MATERIALS, (2) PERSONAL INJURY OR
PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR
ACCESS TO AND USE OF THE ALCHEMYST AI, (3) ANY UNAUTHORIZED ACCESS
...
ALCHEMYST AI, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH
MAY BE TRANSMITTED TO OR THROUGH THE ALCHEMYST AI BY ANY THIRD
...
MADE AVAILABLE VIA THE ALCHEMYST AI. WE DO NOT WARRANT, ENDORSE,
GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE
ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE ALCHEMYST AI,
...
OTHER DAMAGES ARISING FROM YOUR USE OF THE ALCHEMYST AI, EVEN IF WE
...
PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING SUBJECT TO A MAXIMUM
AMOUNT OF INDIAN RUPEES ONE LAKH. CERTAIN US STATE LAWS AND
...
by any third party due to or arising out of: (1) your Contributions; (2) use of the Alchemyst AI;
...
Alchemyst AI with whom you connected via the Alchemyst AI. Notwithstanding the foregoing,
we reserve the right, at your expense, to assume the exclusive defence and control of any matter
for which you are required to indemnify us, and you agree to cooperate, at your expense, with
our defence of such claims. We will use reasonable efforts to notify you of any such claim,
...
that you transmit or that relates to any activity you have undertaken using the Alchemyst AI.
...
via email and on the Alchemyst AI, satisfy any legal requirement that such communication be
...
COMPLETED BY US OR VIA THE ALCHEMYST AI. You hereby waive any rights or
...
Terms of Use is determined to be unlawful, void, or unenforceable, that provision or part of
...
or agency relationship created between you and us as a result of these Terms of Use or use of
the Site. You agree that these Terms of Use will not be construed against us by virtue of having
drafted them. You hereby waive any and all defences you may have based on the electronic
form of these Terms of Use and the lack of signing by the parties hereto to execute these Terms
of Use.
24. CONTACT US
In order to resolve a complaint regarding the Alchemyst AI or to receive further information
regarding use of the Alchemyst AI, please contact us at:
XALCHEMYST TECHNOLOGIES PRIVATE LIMITED
Registered Office: 3rd Floor, Flat 3/A, 20 P C Ghosh Road, Patipukur, North 24Parganas,
Patipukur, West Bengal, India, 700048 India
Phone: 8910016942
Email: uttaran@getalchemystai.com
    </div>
  )
}
