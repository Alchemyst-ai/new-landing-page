      ...
      <ol>
        ...
        <li className = "mb-4">
          ...
          <ul className="pl-4 pb-2 text-gray-400">
              ...
              <li>Disguises or attempts to disguise the origin of your messages, content, including but not limited to by: (a) submitting your content under a false name or false pretences; or (b) disguising or attempting to disguise the IP address from which your content is submitted;</li>
              <li>Harms minors in any way;</li>
              <li>Infringes any patent, trademark, copyright or another proprietary/intellectual property right;</li>
              <li>Violates any applicable law and/ or may result in a civil/ criminal liability;</li>
...
with these terms
 ...
 and collectively, the “Disputes”) brought by either you or us
          ...
          <p className="text-gray-400">
              ...
              be held at West Bengal and all proceedings in any such arbitration shall be conducted in English.
              There shall be 3 (three) arbitrators (“Arbitrators”), all of whom shall be fluent in English. Within
              thirty 30 (thirty) Days of the reference of the dispute to arbitration, the Party raising the dispute
              and making the reference to arbitration shall appoint one Arbitrator and the other Party shall
              appoint the other Arbitrator. The third Arbitrator shall be appointed by the 2 (two) appointed
              Arbitrators. The arbitral award shall be final and binding upon the parties. The Parties shall equally
              bear the costs and expenses for the conduct of the arbitration proceedings, however; each Party
