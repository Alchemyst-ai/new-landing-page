...
//       <h1 className="text-5xl font-bold mb-2 mt-44">TERMS OF USE</h1>
//       <p className="mb-4 pl-2 text-gray-400">
...
//             {", "}
//             <span className="text-orange-400">“us"</span>, or{" "}
//             <span className="text-orange-400">“our” </span>), concerning your
//             access to and use of the{" "}
//             <a href="https://getalchemystai.com/">
//               <u>https://getalchemystai.com</u>
//             </a>{" "}
//             website as well as any other media form (collectively, the “Site”).
//             We are registered in India and have our registered office 3rd Floor,
//             Flat 3/A, 20 P C Ghosh Road, Patipukur, North 24Parganas, Patipukur,
//             West Bengal, India, 700048. You agree that by accessing the website,
...
//           </p>
//           <p>
//             The Website is owned and operated by Xalchemyst Technologies Private
//             Limited. We have been incorporated under the Companies Act, 2013
//             under CIN U62011WB2024PTC270934 having its registered office at 3rd
//             Floor, Flat 3/A, 20 P C Ghosh Road, Patipukur, North 24Parganas,
//             Patipukur, West Bengal, India, 700048.
//           </p>
//           <p>
...
//             competition laws of the India, international copyright laws, and
//             international conventions. The Content and the Marks are provided on
//             the Site “Alchemyst AI” for your information and personal use only.
...
//         <h2 className="text-4xl font-semibold mb-4">3. USER REPRESENTATIONS</h2>
//         <div className="space-y-4">
//           <p>
...
//         <div className="space-y-4">
//           <p>
//             Our platform does not require any User Registration. For the purpose
//             of submitting of information, any user can submit the information
//             through Alchemyst Website. By agreeing to the Terms, you agree to
//             receive promotional, transactional or other communications, and
//             newsletters from the Company. You can opt out from such
//             communications and/or newsletters by using or clicking the link for
//             the opt out options as available in such communications.
//           </p>
//           <p>
...
//             education, address etc). Information so collected is subject to the
        ...
        <ol>
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              (&ldquo;you&rdquo;) and Xalchemyst Technologies Private Limited,
              doing business as (&ldquo;Company,&rdquo; &ldquo;we,&rdquo;
              ...
              &ldquo;Site&rdquo;). We are registered in India and have our
              registered office at 3rd Floor, Flat 3/A, 20 P C Ghosh Road,
              Patipukur, North 24Parganas, Patipukur, West Bengal, India,
              700048. You agree that by accessing the website, you have read,
            ...
            <p className="text-gray-400">
              Our artificial intelligence platform enables businesses by
              providing products/services which help them in automating various
              business processes like sales automation, marketing automation,
              communication, software development, technology platforms,
              cloud-based platforms, data storage, web designing, Information
              Technology, database, IT tools and information products, web and
              mobile application development, lead generation, and user
              interface solutions.
            </p>
          </li>
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              unfair competition laws of India, international copyright laws,
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              purpose of submitting information, any user can submit the
              information through the Alchemyst Website. By agreeing to the
              Terms, you agree to receive promotional, transactional or other
            ...
            <p className="text-gray-400">
              ...
              the Company’s <a href="#">Privacy Policy</a>.
            </p>
          </li>
          <li className="mb-4">
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              Such limited license does not include/permit any resale or
              commercial use of the Alchemyst Website or its contents; any
              collection, use or derivative use of the Website, its contents,
              any product listings, descriptions, or prices; any downloading or
              copying of information for the benefit of another third party; or
              any use of data mining, robots, or similar data gathering and
              extraction tools.
            </p>
            <p className="text-gray-400">
              You hereby agree and undertake not to use, host, display, upload,
              modify, publish, transmit, update or share any information/
              content/ message/ language/ document (including pursuant to
              gifting services/ printing services/ orders to be delivered to
              someone else-3rd party recipients/ messages to be delivered along
              with the order) (whether in writing or otherwise while
              communicating on the Alchemyst AI Platform including but not
              limited to communicating with our support agents or delivery
              partners, through any medium) which (“Prohibited Conduct”):
            </p>
            <ul className="pl-4 pb-2 text-gray-400">
              <li>
              ...
              <li>
                ...
                laundering or gambling, or otherwise offensive, objectionable,
                menacing, inappropriate or unlawful in any manner whatever;
              </li>
              <li>
              ...
              <li>
                ...
                content, including but not limited to by: (a) submitting your
                content under a false name or false pretences; or (b) disguising
                or attempting to disguise the IP address from which your content
                is submitted;
              </li>
            ...
            <p className="text-gray-400">
              ...
              – or anyone elses – access to or use of the Services for
            ...
            <p className="text-gray-400">
              ...
              the company’s name or trademarks without the express prior written
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              Alchemyst AI (&lt;Submissions&gt; ) provided by you to us are
          ...
          <li className="mb-4">
            ...
            <br />
            <p className="text-gray-400">
              The Alchemyst AI may contain (or you may be sent via the Site)
            ...
            <p className="text-gray-400">
              ...
              Alchemyst AI or relating to any applications you use or install
              from the Alchemyst AI.
            </p>
            <br />
            <p className="text-gray-400">
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              Alchemyst AI for violations of these Terms of Use; (2) take
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              believe that any material available on or through the Alchemyst AI
              ...
              that material located on or linked to by the Alchemyst AI
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              use the Alchemyst AI. WITHOUT LIMITING ANY OTHER PROVISION OF
              THESE TERMS OF USE, WE RESERVE THE RIGHT TO, IN OUR SOLE
              DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE
              OF THE ALCHEMYST AI (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO
              ...
              ALCHEMYST AI OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              the Alchemyst AI at any time or for any reason at our sole
              discretion without notice. However, we have no obligation to
              update any information on our Alchemyst AI. We also reserve the
              right to modify or discontinue all or part of the Site without
              notice at any time. We will not be liable to you or any third
              party for any modification, price change, suspension, or
              discontinuance of the Alchemyst AI.
            </p>
            <br />
            <p className="text-gray-400">
              We cannot guarantee the Alchemyst AI will be available at all
              times. We may experience hardware, software, or other problems or
              need to perform maintenance related to the Alchemyst AI, resulting
              in interruptions, delays, or errors. We reserve the right to
              change, revise, update, suspend, discontinue, or otherwise modify
              the Alchemyst AI at any time or for any reason without notice to
              ...
              the Alchemyst AI during any downtime or discontinuance of the
              Alchemyst AI. Nothing in these Terms of Use will be construed to
              obligate us to maintain and support the Alchemyst AI or to supply
          ...
          <li>
            ...
            <p className="text-gray-400">
              ...
              and finally and exclusively resolved by arbitration in accordance
              with the Arbitration and Conciliation Act, 1996 or any statutory
              modification or re-enactment thereof for the time being in force.
              The arbitration shall be held at West Bengal and all proceedings
              in any such arbitration shall be conducted in English. There shall
              be 3 (three) arbitrators (“Arbitrators”), all of whom shall be
              fluent in English. Within thirty 30 (thirty) Days of the reference
              of the dispute to arbitration, the Party raising the dispute and
              making the reference to arbitration shall appoint one Arbitrator
              and the other Party shall appoint the other Arbitrator. The third
          ...
          <li className="mb-4">
            ...
            <br />
            <p className="text-gray-400">
              There may be information on the Alchemyst AI that contains
              typographical errors, inaccuracies, or omissions, including
              descriptions, pricing, availability, and various other
              information. We reserve the right to correct any errors,
              inaccuracies, or omissions and to change or update the information
              on the Alchemyst AI at any time, without prior notice.
            </p>
          </li>
          <li className="mb-4">
            <h2>DISCLAIMER</h2> <br />
            <p className="text-gray-400">
              ...
              EXPRESS OR IMPLIED, IN CONNECTION WITH THE ALCHEMYST AI AND YOUR
              ...
              ANY WEBSITES LINKED TO THE ALCHEMYST AI AND WE WILL ASSUME NO
              ...
              INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE ALCHEMYST
              AI, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE
              TRANSMITTED TO OR THROUGH THE ALCHEMYST AI BY ANY THIRD PARTY,
              ...
              VIA THE ALCHEMYST AI. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR
              ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR
              OFFERED BY A THIRD PARTY THROUGH THE ALCHEMYST AI, ANY HYPERLINKED
          ...
          <li className="mb-4">
            ...
            <br />
            <p className="text-gray-400">
              ou agree to defend, indemnify, and hold us harmless, including our
              subsidiaries, affiliates, and all of our respective officers,
              agents, partners, and employees, from and against any loss,
              damage, liability, claim, or demand, including reasonable
              attorneys’ fees and expenses, made by any third party due to or
              arising out of: (1) your Contributions; (2) use of the Alchemyst
              AI; (3) breach of these Terms of Use; (4) any breach of your
              ...
              harmful act toward any other user of the Alchemyst AI with whom
              you connected via the Alchemyst AI. Notwithstanding the foregoing,
          ...
          <li className="mb-4">
            ...
            <br />
            <p className="text-gray-400">
              We will maintain certain data that you transmit to the Alchemyst
              AI for the purpose of managing the performance of the Alchemyst
              AI, as well as data relating to your use of the Alchemyst AI.
              ...
              to any activity you have undertaken using the Alchemyst AI. You
          ...
          <li className="mb-4">
            ...
            <br />
            <p className="text-gray-400">
              Visiting the Alchemyst AI, sending us emails, and completing
              online forms constitute electronic communications. You consent to
              receive electronic communications, and you agree that all
              agreements, notices, disclosures, and other communications we
              provide to you electronically, via email and on the Alchemyst AI,
              ...
              COMPLETED BY US OR VIA THE ALCHEMYST AI. You hereby waive any
          ...
          <li className="mb-4">
            ...
            <br />
            <p className="text-gray-400">
              At the moment we do not have any refund or cancellation policy for
              our product
            </p>
          </li>
          ...
          <li className="mb-4">
            ...
            <p className="text-gray-400">
              ...
              us on the Alchemyst AI or in respect to the Alchemyst AI
          ...
          <li className="mb-4">
            ...
            <br />
            <p className="text-gray-400">
              n order to resolve a complaint regarding the Alchemyst AI or to
              receive further information regarding use of the Alchemyst AI,
              please contact us at: XALCHEMYST TECHNOLOGIES PRIVATE LIMITED
              Registered Office: 3rd Floor, Flat 3/A, 20 P C Ghosh Road,
              Patipukur, North 24Parganas, Patipukur, West Bengal, India, 700048
              India Phone: 8910016942 Email: uttaran@getalchemystai.com
            </p>
          </li>
        </ol>
      </div>
