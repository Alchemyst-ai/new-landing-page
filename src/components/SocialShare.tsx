 ...
 * a copy-to-clipboard button. Neutral hairline buttons that pick up the amber accent on hover.
 */
export default function SocialShare({ title, url }: SocialShareProps) {
  ...
  return (
    <div className="mt-6 border-t border-[#F1E9DA] pt-5">
      <h4 className="mb-3.5 font-mono text-[10.5px] font-semibold uppercase tracking-[0.16em] text-[#78716C]">
        Share this article
      </h4>
      ...
      {copied && (
        <p role="status" className="mt-2.5 font-mono text-[10.5px] uppercase tracking-[0.12em] text-[#B45309]">
