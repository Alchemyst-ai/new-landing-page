...
export const DiscordCommunityButton = () => {
	...
	return (
		<Link
			...
			className="flex items-center space-x-2 rounded-full transition-all text-sm font-medium"
		>
			<Button
				variant="ghost"
				className="flex items-center mx-2 px-4 py-1 font-medium rounded-full gap-2 cursor-pointer"
			>
				<svg
					role="img"
					viewBox="0 0 24 24"
					xmlns="http://www.w3.org/2000/svg"
					id="Discord--Streamline-Simple-Icons"
					height="26"
					width="26"
				>
