...
export const DiscordCommunityButton = () => {
  const [memberData, setMemberData] = useState<DiscordInviteData | null>(null);
  ...
  return (
    <Link
      href="/join-discord?utm_source=landing_page&utm_medium=redirect&utm_campaign=discord_join"
      target="_blank"
