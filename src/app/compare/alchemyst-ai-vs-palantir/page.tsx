...
<h2 style={{ fontSize: "1.75rem", fontWeight: 700, marginBottom: "20px" }}>
            ...
            <p style={{ marginBottom: "24px" }}>
              Palantir solves this by mapping all business relationships into an organization-wide knowledge graph&mdash;an <em>ontology</em>. They embed Forward Deployed Engineers (FDEs) within client teams to operationalize this ontology. It is highly effective, but it relies entirely on manual, top-down curation to maintain.
            </p>
...
<h2 style={{ fontSize: "1.75rem", fontWeight: 700, marginBottom: "20px" }}>
            ...
            <p style={{ marginBottom: "24px" }}>
              The moment an ontology is deployed, it begins to decay. As teams evolve, pricing tiers change, and new segments emerge, the original semantic consensus fractures&mdash;a phenomenon known as <strong>Semantic Drift</strong> (or Context Rot). 
            </p>
            <p style={{ marginBottom: "24px" }}>
