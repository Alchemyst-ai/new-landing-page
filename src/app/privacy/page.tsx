    ...
    <>
      ...
      <main style={{ background: "var(--paper)", color: "var(--ink)", minHeight: "100vh", padding: "120px 0 80px" }}>
        <article className="container" style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <h2 style={{ color: "#4A3B33", fontSize: "1.5rem", fontWeight: 700, marginTop: "36px", marginBottom: "16px" }}>Summary of key points</h2>
          <p style={{ fontFamily: "var(--font-merriweather), Georgia, serif", fontSize: "1.0625rem", lineHeight: 1.7, color: "#57534E", marginBottom: "16px" }}>
          ...
          <h2 style={{ color: "#4A3B33", fontSize: "1.5rem", fontWeight: 700, marginTop: "36px", marginBottom: "16px" }}>What we collect and why</h2>
          <p style={{ fontFamily: "var(--font-merriweather), Georgia, serif", fontSize: "1.0625rem", lineHeight: 1.7, color: "#57534E", marginBottom: "16px" }}>
          ...
          <h2 style={{ color: "#4A3B33", fontSize: "1.5rem", fontWeight: 700, marginTop: "36px", marginBottom: "16px" }}>Your rights and contact</h2>
          <p style={{ fontFamily: "var(--font-merriweather), Georgia, serif", fontSize: "1.0625rem", lineHeight: 1.7, color: "#57534E", marginBottom: "16px" }}>
            To exercise access, correction, deletion, or consent withdrawal, email <a href="mailto:founders@getalchemystai.com" style={{ color: "#B45309" }}>founders@getalchemystai.com</a> or write to Xalchemyst Technologies Private Limited, 3rd Floor, Flat 3/A, 20 P C Ghosh Road, Patipukur, Kolkata, West Bengal, India 700048. Also see <Link href="/about" style={{ color: "#B45309" }}>About Alchemyst AI</Link>, <Link href="/contact" style={{ color: "#B45309" }}>Contact</Link>, <Link href="/sitemap.xml" style={{ color: "#B45309" }}>sitemap</Link>, and <Link href="/llms.txt" style={{ color: "#B45309" }}>llms.txt</Link>.
          </p>
        </article>
      </main>
      <Footer />
