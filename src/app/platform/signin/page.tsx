...
export default function PlatformSignInPage() {
  ...
  return (
    <div className="flex-col min-h-screen dark bg-zinc-950">
      <div className='text-zinc-300 mb-3 flex align-center w-screen text-center justify-center text-md py-3 bg-zinc-800/70 tracking-wide '>Signup with business email and get 5 million tokens free!</div>
              ...
              <div className="mt-auto pt-6 w-full flex flex-col items-center gap-3">
                <div className="flex gap-4 justify-center items-center">
                  ...
                  <a
                    ...
                    className="text-white/60 hover:text-white transition-colors"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-linkedin-icon lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>
                  </a>
                </div>
