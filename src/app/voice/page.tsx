...
export default function VoicePage() {
  return (
    <div className="min-h-screen" style={{ background: '#0d0d0f' }}>
      {/* Left border line */}
      <div 
        className="fixed left-12 md:left-24 lg:left-32 xl:left-48 2xl:left-64 top-0 bottom-0 w-px z-50"
        style={{ background: 'linear-gradient(to bottom, transparent 0%, rgba(139, 92, 246, 0.3) 10%, rgba(139, 92, 246, 0.3) 90%, transparent 100%)' }}
      />
      {/* Right border line */}
      <div 
        className="fixed right-12 md:right-24 lg:right-32 xl:right-48 2xl:right-64 top-0 bottom-0 w-px z-50"
        style={{ background: 'linear-gradient(to bottom, transparent 0%, rgba(139, 92, 246, 0.3) 10%, rgba(139, 92, 246, 0.3) 90%, transparent 100%)' }}
      />
      
      {/* Main content container */}
      <div className="mx-12 md:mx-24 lg:mx-32 xl:mx-48 2xl:mx-64">
        <VoiceHero />
        <VoiceTrusted />
