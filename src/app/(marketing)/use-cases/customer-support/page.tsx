        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="text-white">Make Learning<br />Truly Personalized</span>
            </h1>
      ...
      <div className="w-full bg-[#0E0E0C] py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Problems Faced in EdTech</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-red-900/20 p-6 rounded-xl border border-red-800/50">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Lack of Context of Previous Sessions</h3>
            ...
            <div className="bg-orange-900/20 p-6 rounded-xl border border-orange-800/50">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Too Generalised Teaching</h3>
              <p className="text-gray-400">
      ...
      <div className="w-full bg-black py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">EdTech Solutions with Alchemyst</h2>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Transform education with memory-powered AI that addresses core challenges in learning and teaching.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Teach Less Admin, Learn More</h3>
              <p className="text-gray-400">
                With Alchemyst, teacher-facing AI cuts up to 60% of admin workload by syncing attendance, grading, and LMS data—freeing 8+ hours per week for real instruction.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Every Learner, Fully Understood</h3>
              <p className="text-gray-400">
                Alchemyst builds a 360° learner profile by unifying SIS, clickstream, and prior knowledge data. Result: 14 pp higher engagement and up to 30% gains in learning outcomes.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Trustworthy Agents for Safe Classrooms</h3>
              <p className="text-gray-400">
                Governed AI matters in education. Alchemyst enforces access rules, prevents leakage, and reduces unintended AI behavior by over 70%—keeping learning secure and on track.
              </p>
            </div>
          </div>
        </div>
