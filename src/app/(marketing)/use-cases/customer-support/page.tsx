				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-12">
						...
						<p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
							Enhance customer experience with AI agents that remember context,
							learn from interactions, and deliver personalized support at
							scale.
						</p>
					</div>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
							Current support systems struggle with coordination,
							prioritization, and context retention.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="bg-muted p-6 rounded-xl border border-border">
							...
							<p className="text-muted-foreground">
								Critical issues buried in queue without proper urgency
								detection.
							</p>
						</div>
						...
						<div className="bg-muted p-6 rounded-xl border border-border">
							...
							<p className="text-muted-foreground">
								Previous interactions invisible, forcing customers to restart
								explanations.
							</p>
						</div>
					</div>
			...
			<div className="w-full bg-card py-16 px-4">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
							Transform customer support with memory-powered AI that delivers
					...
					<div className="grid md:grid-cols-2 gap-12 items-center">
						...
						<div className="space-y-6">
							...
							<p className="text-lg text-muted-foreground mb-8">
								Handle more support tickets with less resources while
								maintaining quality.
							</p>
