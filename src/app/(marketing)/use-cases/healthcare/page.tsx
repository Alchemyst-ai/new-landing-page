				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-12">
						...
						<p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
							Enhance patient care with memory-powered AI that understands
							context, history, and individual needs.
						</p>
					</div>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-12">
						...
						<h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
							Problems Faced in Healthcare
						</h2>
						<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
							Current AI healthcare solutions struggle with context retention
							and personalization, leading to suboptimal patient care
							experiences.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="bg-muted p-6 rounded-xl border border-border">
							...
							<p className="text-muted-foreground">
								Agents can't retain context of previous conversations, leading
								to unreliable treatment plans suggested.
							</p>
						</div>
						...
						<div className="bg-muted p-6 rounded-xl border border-border">
							...
							<h3 className="text-xl font-semibold text-foreground mb-3">
								No Connection for Patients
							</h3>
							<p className="text-muted-foreground">
								Patients have to give their details multiple times for each
								query.
							</p>
						</div>
			...
			<div className="w-full bg-card py-16 px-4">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
							Transform patient care with memory-powered AI that understands
						...
						<div className="space-y-6">
							...
							<div className="bg-card p-6 rounded-xl border border-border">
								...
								<div className="mb-4">
									...
									<div className="w-full bg-muted rounded-full h-3">
										<div
											className="bg-foreground h-3 rounded_full"
											style={{ width: "45%" }}
										></div>
									</div>
									<p className="text-xs text-muted-foreground mt-2">
