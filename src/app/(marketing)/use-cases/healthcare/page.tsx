        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="text-foreground">Transform Healthcare<br />with Intelligent Memory</span>
            </h1>
      ...
      <div className="w-full bg-background py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Problems Faced in Healthcare</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-muted p-6 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Very Generic Suggestions</h3>
            ...
            <div className="bg-muted p-6 rounded-xl border border-border">
              <div className="mb-4">
                <div className="w-12 h-12 bg-secondary rounded-lg flex items-center justify_center mb-4">
                  <svg className="w-6 h-6 text-foreground/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-3">No Connection for Patients</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-muted p-6 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">No Progress Retention</h3>
              <p className="text-muted-foreground">
      ...
      <div className="w-full bg-card py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Intelligent Healthcare Features</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card p-6 rounded-xl border border-border">
                ...
                <div className="mb-4">
                  ...
                  {/* Neutral Progress Bar */}
                  <div className="w-full bg-muted rounded-full h-3">
                    <div className="bg-foreground h-3 rounded_full" style={{ width: '45%' }}></div>
                  </div>
