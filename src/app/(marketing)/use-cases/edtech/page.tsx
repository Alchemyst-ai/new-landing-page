				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-12">
						...
						<p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
							With memory, AI tutors can track progress, understand learning
							patterns, and personalize over time.
						</p>
					</div>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
							Current AI education tools struggle with context retention and
							personalization, leading to suboptimal learning experiences.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="bg-muted p-6 rounded-xl border border-border">
							...
							<p className="text-muted-foreground">
								New sessions lack preferences and context awareness of user
						...
						<div className="bg-muted p-6 rounded-xl border border-border">
							...
							<p className="text-muted-foreground">
								The inability of retaining previous context makes the guidance
								generic and fruitless.
							</p>
						</div>
			...
			<div className="w-full bg-card py-16 px-4">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
							Transform education with memory-powered AI that adapts and
