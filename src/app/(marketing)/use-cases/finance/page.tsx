        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="text-foreground">Supercharge Your<br />Financial Operations</span>
            </h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-muted p-6 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Repetitive Fraud Checks</h3>
            ...
            <div className="bg-muted p-6 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Rigid Payments Logic</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-muted p-6 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Fragmented Case Data</h3>
              <p className="text-muted-foreground">
      ...
      <div className="w-full bg-card py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Intelligent Financial Features</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
