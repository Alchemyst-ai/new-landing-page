        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="text-white">Supercharge Your<br />Financial Operations</span>
            </h1>
      ...
      <div className="w-full bg-black py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Financial Solutions with Alchemyst</h2>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Transform financial operations with memory-powered AI that addresses core challenges in fraud detection, payments, and KYC.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Fraud & AML</h3>
              <p className="text-gray-400">
                Tracks entities & device fingerprints, skips redundant past checks → 50% token drop on 10M checks → $1M+ saved annually at a mid-tier neo-bank.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Payments & Credit</h3>
              <p className="text-gray-400">
                Remembers issuer quirks & merchant edge cases → 20ms faster auth + measurable lift in approval rates. Avoids full loan-ledger roundtrips → 70% cheaper BNPL eligibility checks.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">KYC & Case Handling</h3>
              <p className="text-gray-400">
                Pulls KYC, device, network, payment trails into one memory → agents see full case state instantly → faster decisions, fewer repeat reviews.
              </p>
            </div>
          </div>
        </div>
