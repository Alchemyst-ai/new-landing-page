    ...
    <>
      ...
      <main style={{ background: "var(--paper)", color: "var(--ink)", minHeight: "100vh", padding: "120px 0 80px" }}>
        <article className="container" style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <h2 style={{ color: "#4A3B33", fontSize: "1.5rem", fontWeight: 700, marginTop: "36px", marginBottom: "16px" }}>What Alchemyst AI builds</h2>
          <p style={{ fontFamily: "var(--font-merriweather), Georgia, serif", fontSize: "1.0625rem", lineHeight: 1.7, color: "#57534E", marginBottom: "16px" }}>
          ...
          <h2 style={{ color: "#4A3B33", fontSize: "1.5rem", fontWeight: 700, marginTop: "36px", marginBottom: "16px" }}>Why Alchemyst AI exists</h2>
          <p style={{ fontFamily: "var(--font-merriweather), Georgia, serif", fontSize: "1.0625rem", lineHeight: 1.7, color: "#57534E", marginBottom: "16px" }}>
          ...
          <h2 style={{ color: "#4A3B33", fontSize: "1.5rem", fontWeight: 700, marginTop: "36px", marginBottom: "16px" }}>Trust and contact</h2>
          <p style={{ fontFamily: "var(--font-merriweather), Georgia, serif", fontSize: "1.0625rem", lineHeight: 1.7, color: "#57534E", marginBottom: "16px" }}>
            Read our <Link href="/privacy" style={{ color: "#B45309" }}>Privacy Notice</Link>, <Link href="/contact" style={{ color: "#B45309" }}>contact us</Link> at founders@getalchemystai.com. Our registered address is 3rd Floor, Flat 3/A, 20 P C Ghosh Road, Patipukur, Kolkata, West Bengal, India 700048. Explore the <Link href="/sitemap.xml" style={{ color: "#B45309" }}>sitemap</Link>, <Link href="/llms.txt" style={{ color: "#B45309" }}>llms.txt</Link>, <Link href="/developers" style={{ color: "#B45309" }}>developer portal</Link>, and <Link href="/openapi.json" style={{ color: "#B45309" }}>OpenAPI spec</Link>.
          </p>
        </article>
      </main>
      <Footer />
